    ...
    return<>
        <div className='align-optionquiz'>
                    ...
                    <HiMiniXMark />
                        ...
                        <label htmlFor="example6" className="flex block py-4 mb-1 text-sm font-medium text-white"><TbMessage2Question /><span className='px-2 text-xl'>Question type</span></label>
                        ...
                        <div className="max-w-xs mx-auto">
                        <label htmlFor="example6" className="flex block py-4 mb-1 text-sm font-medium text-white"><MdAccessTime /><span className='px-2 text-xl'>Timing</span></label>
                        <div className="relative">
                        ...
                        <div className="max-w-xs mx-auto">
                        <label htmlFor="example6" className="flex block py-4 mb-1 text-sm font-medium text-white"><RiApps2Line /><span className='px-2 text-xl'>Response limite</span></label>
                        <div className="relative">
                            ...
                            <option value="">Choose</option>
                            <option value="unique">Unique selection</option>
                            </select>
                        </div>
                        </div>
